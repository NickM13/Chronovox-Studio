...
namespace ModelMath {
	...
	bool castRayVoxelPlane(glm::vec3 p_start, glm::vec3 p_direction, Matrix *p_matrix, GLfloat &p_near, GLfloat &p_far, glm::ivec3 p_planePoint, Sint8 p_side, glm::ivec3 &p_selectedVoxel, glm::ivec3 &p_selectedVoxelOffset);
