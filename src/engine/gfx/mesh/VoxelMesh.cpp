...
void VoxelMesh::createMesh(Uint16*** p_voxelIds, Sint8*** p_faceData, Vector3<Sint16> p_dimensions)
{
	...
	// Outside voxels are for continued effects - lighting and such - and are not rendered
		...
		for(Uint16 y1 = 0; y1 < p_dimensions.y; y1++)
		{
			...
			for(Uint16 z1 = 0; z1 < p_dimensions.z; z1++)
			{
				...
				if(_faces[x][y][z] & FACE_NORTH)
				{
					...
					{
						m_colors.push_back(_color * ao.x1); m_vertices.push_back(Vector3<GLfloat>(x1, y1, z1));
						m_colors.push_back(_color * ao.y2); m_vertices.push_back(Vector3<GLfloat>(x1, y1, z1 + z2));
						m_colors.push_back(_color * ao.y1); m_vertices.push_back(Vector3<GLfloat>(x1, y1 + y2, z1));

						m_colors.push_back(_color * ao.x2); m_vertices.push_back(Vector3<GLfloat>(x1, y1 + y2, z1 + z2));
						m_colors.push_back(_color * ao.y1); m_vertices.push_back(Vector3<GLfloat>(x1, y1 + y2, z1));
						m_colors.push_back(_color * ao.y2); m_vertices.push_back(Vector3<GLfloat>(x1, y1, z1 + z2));
					}
					else
		...
		for(Uint16 y1 = 0; y1 < p_dimensions.y; y1++)
		{
			...
			for(Uint16 z1 = 0; z1 < p_dimensions.z; z1++)
			{
				...
				if(_faces[x][y][z] & FACE_SOUTH)
				{
					...
					if((p[0] >= p[1] && p[0] >= p[3]) || (p[2] >= p[1] && p[2] >= p[3]))
					{
						m_colors.push_back(_color * ao.x1); m_vertices.push_back(Vector3<GLfloat>(x1 + 1, y1, z1));
						m_colors.push_back(_color * ao.y1); m_vertices.push_back(Vector3<GLfloat>(x1 + 1, y1 + y2, z1));
						m_colors.push_back(_color * ao.y2); m_vertices.push_back(Vector3<GLfloat>(x1 + 1, y1, z1 + z2));

						m_colors.push_back(_color * ao.x2); m_vertices.push_back(Vector3<GLfloat>(x1 + 1, y1 + y2, z1 + z2));
						m_colors.push_back(_color * ao.y2); m_vertices.push_back(Vector3<GLfloat>(x1 + 1, y1, z1 + z2));
						m_colors.push_back(_color * ao.y1); m_vertices.push_back(Vector3<GLfloat>(x1 + 1, y1 + y2, z1));
					}
					else
		...
		for(Uint16 x1 = 0; x1 < p_dimensions.x; x1++)
		{
			...
			for(Uint16 y1 = 0; y1 < p_dimensions.y; y1++)
			{
				...
				if(_faces[x][y][z] & FACE_EAST)
				{
					...
					if((p[0] >= p[1] && p[0] >= p[3]) || (p[2] >= p[1] && p[2] >= p[3]))
					{
						m_colors.push_back(_color * ao.x1); m_vertices.push_back(Vector3<GLfloat>(x1, y1, z1 + 1));
						m_colors.push_back(_color * ao.y1); m_vertices.push_back(Vector3<GLfloat>(x1 + x2, y1, z1 + 1));
						m_colors.push_back(_color * ao.y2); m_vertices.push_back(Vector3<GLfloat>(x1, y1 + y2, z1 + 1));

						m_colors.push_back(_color * ao.x2); m_vertices.push_back(Vector3<GLfloat>(x1 + x2, y1 + y2, z1 + 1));
						m_colors.push_back(_color * ao.y2); m_vertices.push_back(Vector3<GLfloat>(x1, y1 + y2, z1 + 1));
						m_colors.push_back(_color * ao.y1); m_vertices.push_back(Vector3<GLfloat>(x1 + x2, y1, z1 + 1));
					}
					else
		...
		for(Uint16 x1 = 0; x1 < p_dimensions.x; x1++)
		{
			...
			for(Uint16 y1 = 0; y1 < p_dimensions.y; y1++)
			{
				...
				if(_faces[x][y][z] & FACE_WEST)
				{
					...
					{
						m_colors.push_back(_color * ao.x1); m_vertices.push_back(Vector3<GLfloat>(x1, y1, z1));
						m_colors.push_back(_color * ao.y2); m_vertices.push_back(Vector3<GLfloat>(x1, y1 + y2, z1));
						m_colors.push_back(_color * ao.y1); m_vertices.push_back(Vector3<GLfloat>(x1 + x2, y1, z1));

						m_colors.push_back(_color * ao.x2); m_vertices.push_back(Vector3<GLfloat>(x1 + x2, y1 + y2, z1));
						m_colors.push_back(_color * ao.y1); m_vertices.push_back(Vector3<GLfloat>(x1 + x2, y1, z1));
						m_colors.push_back(_color * ao.y2); m_vertices.push_back(Vector3<GLfloat>(x1, y1 + y2, z1));
					}
					else
		...
		for(Uint16 x1 = 0; x1 < p_dimensions.x; x1++)
		{
			...
			for(Uint16 z1 = 0; z1 < p_dimensions.z; z1++)
			{
				...
				if(_faces[x][y][z] & FACE_TOP)
				{
					...
					if((p[0] >= p[1] && p[0] >= p[3]) || (p[2] >= p[1] && p[2] >= p[3]))
					{
						m_colors.push_back(_color * ao.x1); m_vertices.push_back(Vector3<GLfloat>(x1, y1 + 1, z1));
						m_colors.push_back(_color * ao.y2); m_vertices.push_back(Vector3<GLfloat>(x1, y1 + 1, z1 + z2));
						m_colors.push_back(_color * ao.y1); m_vertices.push_back(Vector3<GLfloat>(x1 + x2, y1 + 1, z1));

						m_colors.push_back(_color * ao.x2); m_vertices.push_back(Vector3<GLfloat>(x1 + x2, y1 + 1, z1 + z2));
						m_colors.push_back(_color * ao.y1); m_vertices.push_back(Vector3<GLfloat>(x1 + x2, y1 + 1, z1));
						m_colors.push_back(_color * ao.y2); m_vertices.push_back(Vector3<GLfloat>(x1, y1 + 1, z1 + z2));
					}
					else
			...
			for(Uint16 z1 = 0; z1 < p_dimensions.z; z1++)
			{
				...
				if(_faces[x][y][z] & FACE_BOTTOM)
				{
					...
					if((p[0] >= p[1] && p[0] >= p[3]) || (p[2] >= p[1] && p[2] >= p[3]))
					{
						...
						m_colors.push_back(_color * ao.x2); m_vertices.push_back(Vector3<GLfloat>(x1 + x2, y1, z1 + z2));
						m_colors.push_back(_color * ao.y2); m_vertices.push_back(Vector3<GLfloat>(x1, y1, z1 + z2));
						m_colors.push_back(_color * ao.y1); m_vertices.push_back(Vector3<GLfloat>(x1 + x2, y1, z1));
					}
					else
...
void VoxelMesh::renderMesh()
{
	...
	glColorPointer(4, GL_FLOAT, 0, &m_colors[0].r);
