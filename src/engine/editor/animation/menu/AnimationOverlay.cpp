...
Container* AnimationOverlay::init(Editor* p_editor) {
	...
	Container* titleBar = (Container*)m_container->addComponent(new Container("TITLE", { 0, 0 }, { 0, 28 }, []() { return true; }), Component::Anchor::NONE, Component::Anchor::TOP_RIGHT)->setPriorityLayer(4);
	...
	titleBar->addComponent(new CText("WINDOW_TITLE", GScreen::getWindowTitle(), {30, 14}, {0, 0}, Alignment::ALIGN_LEFT, "textLight"));
	titleBar->addComponent(new CButton("BUTTON_MINIMIZE_WINDOW", "", MTexture::getTexture("gui\\icon\\window\\Minimize.png"),
		{-64, 0}, {32, 28}, CButton::RenderStyle::FILL, []() { /*GScreen::getWindowTitle() = GScreen::WindowCommand::MINIMIZE;*/ }), Component::Anchor::TOP_RIGHT);
	titleBar->addComponent(new CButton("BUTTON_RESIZE_WINDOW", "", MTexture::getTexture("gui\\icon\\window\\Resize.png"),
		{-32, 0}, {32, 28}, CButton::RenderStyle::FILL, []() { /*GScreen::getWindowTitle() = GScreen::WindowCommand::RESIZE;*/ }), Component::Anchor::TOP_RIGHT);
	titleBar->addComponent(new CButton("BUTTON_CLOSE_WINDOW", "", MTexture::getTexture("gui\\icon\\window\\Close.png"),
		{0, 0}, {32, 28}, CButton::RenderStyle::FILL, []() { /*GScreen::getWindowTitle() = GScreen::WindowCommand::CLOSE;*/ }), Component::Anchor::TOP_RIGHT);
	...
	*/
	...
	m_container->addComponent(timeline, Component::Anchor::BOTTOM_LEFT, Component::Anchor::BOTTOM_RIGHT)
		...
		m_container->findComponent("GUI_DETAILS\\GUI_PROPERTIES")->setVisibleFunction([]() { return true; });
	})->setReleaseFunction([]() {
		m_editor->getAnimation()->saveKeyframeProperties();
		m_container->findComponent("GUI_DETAILS\\GUI_PROPERTIES")->setVisibleFunction([]() { return false; });
	});
