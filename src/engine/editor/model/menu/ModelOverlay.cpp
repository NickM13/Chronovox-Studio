...
Container* ModelOverlay::init(Model* p_model) {
	...
	m_container->findComponent("DIALOG_NEWMATRIX")->addComponent(new NumberField("WIDTH", "Width: ", { 50, 60 }, { 100, 1 }, { 0, 128 }, NumberField::NumType::INT), Component::Anchor::TOP_CENTER)
		->setReleaseFunction([]() { m_container->findComponent("DIALOG_NEWMATRIX\\HEIGHT")->setState(1); });
	m_container->findComponent("DIALOG_NEWMATRIX")->addComponent(new NumberField("HEIGHT", "Height: ", { 50, 84 }, { 100, 1 }, { 0, 128 }, NumberField::NumType::INT), Component::Anchor::TOP_CENTER)
		->setReleaseFunction([]() { m_container->findComponent("DIALOG_NEWMATRIX\\DEPTH")->setState(1); });
	m_container->findComponent("DIALOG_NEWMATRIX")->addComponent(new NumberField("DEPTH", "Depth: ", { 50, 108 }, { 100, 1 }, { 0, 128 }, NumberField::NumType::INT), Component::Anchor::TOP_CENTER);
