...
ModelPropertiesDialog::ModelPropertiesDialog() {
	...
	m_dialog->addComponent(new CText("TEXT_OFFSET", "Position", { -58, 66 }, { 0, 0 }, Alignment::ALIGN_CENTER, Color(1, 1, 1)), Component::Anchor::TOP_CENTER);
	m_dialog->addComponent(new NumberField("OFFX", "x: ", { -58, 80 }, { 30, 1 }, { -64, 64 }, NumberField::NumType::INT), Component::Anchor::TOP_CENTER)
		->setReleaseFunction([&]() { m_dialog->findComponent("OFFY")->setState(1); });
	m_dialog->addComponent(new NumberField("OFFY", "y: ", { -58, 104 }, { 30, 1 }, { -64, 64 }, NumberField::NumType::INT), Component::Anchor::TOP_CENTER)
		->setReleaseFunction([&]() { m_dialog->findComponent("OFFZ")->setState(1); });
	m_dialog->addComponent(new NumberField("OFFZ", "z: ", { -58, 128 }, { 30, 1 }, { -64, 64 }, NumberField::NumType::INT), Component::Anchor::TOP_CENTER)
		->setReleaseFunction([&]() { m_dialog->findComponent("WIDTH")->setState(1); });
	m_dialog->addComponent(new CText("TEXT_SIZE", "Size", { 58, 66 }, { 0, 0 }, Alignment::ALIGN_CENTER, Color(1, 1, 1)), Component::Anchor::TOP_CENTER);
